...
public class Message0x02TENBTData extends SimpleChannelInboundHandler<Message0x02TENBTData> implements IWailaMessage {
    ...
    public Message0x02TENBTData(final NBTTagCompound tag) {
        this.tag = tag;
    }
    ...
    @Override
    protected void channelRead0(final ChannelHandlerContext ctx, final Message0x02TENBTData msg) throws Exception {
