    ...
    public void onKeyEvent(final KeyInputEvent event) {
        ...
        if (Keyboard.getEventKeyState()) {
            if (key == key_cfg.getKeyCode()) {
                ...
                final boolean status = ConfigHandler.instance().getConfig(Configuration.CATEGORY_GENERAL, Constants.CFG_WAILA_SHOW, true);
                ...
                final boolean status = ConfigHandler.instance().getConfig(Configuration.CATEGORY_GENERAL, Constants.CFG_WAILA_LIQUID, true);
