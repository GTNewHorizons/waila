...
public class HUDFMPGateLogic implements IWailaFMPProvider {
    ...
    @Override
    public List<String> getWailaHead(final ItemStack itemStack, final List<String> currenttip, final IWailaFMPAccessor accessor, final IWailaConfigHandler config) {
        return currenttip;
    }

    @Override
    public List<String> getWailaBody(final ItemStack itemStack, final List<String> currenttip, final IWailaFMPAccessor accessor, final IWailaConfigHandler config) {
    ...
    @Override
    public List<String> getWailaTail(final ItemStack itemStack, final List<String> currenttip, final IWailaFMPAccessor accessor, final IWailaConfigHandler config) {
        return currenttip;
    }
