...
public class ConfigHandler implements IWailaConfigHandler {
    ...
    public void addModule(final String modName, final HashMap<String, String> options) {
        this.addModule(modName, new ConfigModule(modName, options));
    }

    public void addModule(final String modName, final ConfigModule options) {
    ...
    @Override
    public HashMap<String, String> getConfigKeys(final String modName) {
    ...
    private void saveModuleKey(final String modName, final String key) {
        this.saveModuleKey(modName, key, Constants.CFG_DEFAULT_VALUE);
    }

    private void saveModuleKey(final String modName, final String key, final boolean defvalue) {
        config.get(Constants.CATEGORY_MODULES, key, defvalue);
        config.get(Constants.CATEGORY_SERVER, key, Constants.SERVER_FREE);
        config.save();
    }

    public void addConfig(final String modName, final String key, final String name) {
        this.addConfig(modName, key, name, Constants.CFG_DEFAULT_VALUE);
    }

    public void addConfig(final String modName, final String key, final String name, final boolean defvalue) {
    ...
    public void addConfigServer(final String modName, final String key, final String name) {
        this.addConfigServer(modName, key, name, Constants.CFG_DEFAULT_VALUE);
    }

    public void addConfigServer(final String modName, final String key, final String name, final boolean defvalue) {
        this.saveModuleKey(modName, key, defvalue);
    ...
    @Override
    public boolean getConfig(final String key, final boolean defvalue) {
        ...
        final Property prop = config.get(Constants.CATEGORY_MODULES, key, defvalue);
        return prop.getBoolean(defvalue);
    }

    public boolean isServerRequired(final String key) {
    ...
    public boolean getConfig(final String category, final String key, final boolean default_) {
        final Property prop = config.get(category, key, default_);
        return prop.getBoolean(default_);
    }

    public void setConfig(final String category, final String key, final boolean state) {
        config.getCategory(category).put(key, new Property(key, String.valueOf(state), Property.Type.BOOLEAN));
        config.save();
    }

    public int getConfig(final String category, final String key, final int default_) {
        final Property prop = config.get(category, key, default_);
        return prop.getInt();
    }

    public void setConfig(final String category, final String key, final int state) {
    ...
    public void loadDefaultConfig(final FMLPreInitializationEvent event) {
