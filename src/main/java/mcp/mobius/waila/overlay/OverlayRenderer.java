...
public class OverlayRenderer {
    ...
    public static void renderOverlay(final Tooltip tooltip) {
...
//        	System.out.println("" + tooltip.stack.getDisplayName() + tooltip.stack.getMetadata());
    ...
    public static void drawTooltipBox(final int x, final int y, final int w, final int h, final int bg, final int grad1, final int grad2) {
        //int bg = 0xf0100010;
