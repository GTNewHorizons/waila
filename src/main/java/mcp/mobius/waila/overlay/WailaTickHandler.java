...
public class WailaTickHandler {
    ...
    public void tickRender(final TickEvent.RenderTickEvent event) {
    ...
    public void tickClient(final TickEvent.ClientTickEvent event) {
        ...
        if (world != null && player != null) {
            ...
            final RayTraceResult target = RayTracing.instance().getTarget();

            if (target != null && target.typeOfHit == RayTraceResult.Type.BLOCK) {
                final DataAccessorCommon accessor = DataAccessorCommon.instance;
                accessor.set(world, player, target);
                final ItemStack targetStack = RayTracing.instance().getTargetStack();    // Here we get either the proper stack or the override
                ...
                final Entity targetEnt = RayTracing.instance().getTargetEntity(); // This need to be replaced by the override check.
