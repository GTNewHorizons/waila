...
public class ScreenTest2 extends ScreenBase {
    ...
    public ScreenTest2(GuiScreen parent) {
        super(parent);
        // this.getRoot().addWidget("Picture", new PictureSwitch(this.getRoot(), "waila:textures/test.png",
        // "waila:textures/test_solar.png"));
        // this.getRoot().addWidget("Button", new ButtonInteger(this.getRoot(), "Val0", "Val1", "Val2"));
        // this.getRoot().getWidget("Button").setGeometry(new WidgetGeometry(50.0D, 50.0D, 100.0D, 20.0D, true, false,
        // WidgetAlign.CENTER, WidgetAlign.CENTER));
        ...
        // ((ButtonContainer)this.getRoot().getWidget("Buttons")).addButton(new ButtonIntegerConfig(this.getRoot(),
        // "testconfig", true, 0, "Val0", "Val1", "Val2"));
