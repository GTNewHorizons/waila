...
public class ScreenEnchants extends ScreenBase {
    ...
    public ScreenEnchants(final GuiScreen parent) {
        super(parent);
        ...
        final String columnName = "\u00a7a\u00a7o" + LangUtil.translateG("enchant.title.name");
        final String columnMinLvl = "\u00a7a\u00a7o" + LangUtil.translateG("enchant.title.minlvl");
        ;
        final String columnMaxLvl = "\u00a7a\u00a7o" + LangUtil.translateG("enchant.title.maxlvl");
        ;
        final String columnWeight = "\u00a7a\u00a7o" + LangUtil.translateG("enchant.title.weight");
        ;
    ...
    public ScreenEnchants addRow(final String... strings) {
        this.getTable().addRow(strings);
        return this;
    }

    public ScreenEnchants setStack(final ItemStack stack) {
    ...
    public ScreenEnchants setName(final String name) {
        ((LabelFixedFont) this.getRoot().getWidget("Layout_Title").getWidget("LabelName")).setText(name);
        this.getRoot().getWidget("Layout_Title").adjustSize();
        return this;
    }

    public ScreenEnchants setEnchantability(final String value) {
