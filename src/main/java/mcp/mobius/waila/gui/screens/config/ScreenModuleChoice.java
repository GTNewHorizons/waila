...
public class ScreenModuleChoice extends ScreenBase {
    ...
    public ScreenModuleChoice(final GuiScreen parent) {
        super(parent);
        ...
        final ButtonContainer buttonContainer = ((ButtonContainer) this.getRoot().getWidget("ButtonContainer"));

        for (final String key : ConfigHandler.instance().getModuleNames())
