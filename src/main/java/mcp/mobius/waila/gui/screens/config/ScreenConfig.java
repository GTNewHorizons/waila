...
public class ScreenConfig extends ScreenBase {
    ...
    public ScreenConfig(GuiScreen parent) {
        ...
        this.getRoot().getWidget("ButtonContainer").setGeometry(
                new WidgetGeometry(50.0, 50.0, 50.0, 30.0, CType.RELXY, CType.REL_X, WAlign.CENTER, WAlign.CENTER));

        ButtonContainer buttonContainer = ((ButtonContainer) this.getRoot().getWidget("ButtonContainer"));

        buttonContainer
                .addButton(new ButtonScreenChange(this.getRoot(), "screen.button.waila", new ScreenWailaConfig(this)));
        buttonContainer.addButton(
                new ButtonScreenChange(this.getRoot(), "screen.button.modules", new ScreenModuleChoice(this)));
