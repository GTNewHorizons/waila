...
public class ScreenModuleConfig extends ScreenBase {
    ...
    public ScreenModuleConfig(final GuiScreen parent, final String modname) {
        super(parent);
        ...
        final ButtonContainerLabel buttonContainer = ((ButtonContainerLabel) this.getRoot().getWidget("ButtonContainer"));

        for (final String key : ConfigHandler.instance().getConfigKeys(this.modName).keySet()) {
