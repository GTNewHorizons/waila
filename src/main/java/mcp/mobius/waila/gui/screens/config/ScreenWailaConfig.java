...
public class ScreenWailaConfig extends ScreenBase {
    ...
    public ScreenWailaConfig(GuiScreen parent) {
        ...
        this.getRoot().getWidget("ButtonContainer")
                .setGeometry(new WidgetGeometry(0.0, 10.0, 100.0, 50.0, CType.RELXY, CType.RELXY));
        ...
        buttonContainer.addButton(
                new ButtonBooleanConfig(
                        ...
                        Constants.CFG_WAILA_SHOW,
                        true,
                        true,
                        "screen.button.hidden",
                        "screen.button.visible"),
                "choice.showhidewaila");
        buttonContainer.addButton(
                new ButtonBooleanConfig(
                        this.getRoot(),
                        Configuration.CATEGORY_GENERAL,
                        Constants.CFG_WAILA_MODE,
                        true,
                        true,
                        "screen.button.maintained",
                        "screen.button.toggled"),
                "choice.toggledmaintained");
        buttonContainer.addButton(
                new ButtonBooleanConfig(
                        this.getRoot(),
                        Configuration.CATEGORY_GENERAL,
                        Constants.CFG_WAILA_METADATA,
                        true,
                        false,
                        "screen.button.hidden",
                        "screen.button.visible"),
        ...
        buttonContainer.addButton(
                new ButtonBooleanConfig(
                        this.getRoot(),
                        Configuration.CATEGORY_GENERAL,
                        Constants.CFG_WAILA_SHIFTBLOCK,
                        true,
                        false,
                        "screen.button.no",
                        "screen.button.yes"),
        ...
        buttonContainer.addButton(
                new ButtonBooleanConfig(
                        this.getRoot(),
                        Configuration.CATEGORY_GENERAL,
                        Constants.CFG_WAILA_FORCE_LEGACY_MODE,
                        true,
                        false,
                        "screen.button.no",
                        "screen.button.yes"),
                "choice.forcelegacymode");

        this.getRoot().addWidget("LayoutConfigPos", new LayoutBase(this.getRoot()));
        this.getRoot().getWidget("LayoutConfigPos")
                .setGeometry(new WidgetGeometry(0.0, 50.0, 100.0, 20.0, CType.RELXY, CType.RELXY));
        this.getRoot().getWidget("LayoutConfigPos").addWidget(
                "ButtonConfigPos",
        ...
        this.getRoot().getWidget("LayoutBack")
                .addWidget("ButtonBack", new ButtonScreenChange(null, "screen.button.back", this.parent));
