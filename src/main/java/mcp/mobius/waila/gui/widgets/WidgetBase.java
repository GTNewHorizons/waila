...
public abstract class WidgetBase implements IWidget {
    ...
    public void draw() {
        ...
        for (IWidget widget : this.renderQueue_HIGH.values()) if (widget.shouldRender()) widget.draw();
    ...
    public void emit(Signal signal, Object... params) {
        if (this.parent != null) this.parent.onWidgetEvent(this, signal, params);
    }

    @Override
    public void onWidgetEvent(IWidget srcwidget, Signal signal, Object... params) {
        if (this.parent != null) this.parent.onWidgetEvent(srcwidget, signal, params);
    }
}
