...
public class LayoutCanvas extends LayoutBase {
    ...
    public void handleMouseInput() {
        ...
        final MouseEvent event = new MouseEvent(this);
        final EventType type = event.getEventType(this.lastMouseEvent);
        final IWidget targetWidget = this.getWidgetAtCoordinates(event.x, event.y);
