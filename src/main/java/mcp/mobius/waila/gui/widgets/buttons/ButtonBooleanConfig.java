...
public class ButtonBooleanConfig extends ButtonBoolean {
    ...
    public ButtonBooleanConfig(final IWidget parent, final String category, final String configKey, final String textFalse, final String textTrue) {
        this(parent, category, configKey, true, true, textFalse, textTrue);
    }

    public ButtonBooleanConfig(final IWidget parent, final String category, final String configKey, final boolean instant, final boolean state_, final String textFalse, final String textTrue) {
